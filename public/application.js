...
var config = {
  apiOrigins: {
    production: 'https://av-repertoire.herokuapp.com',
...
var createSong = function createSong(data) {
  var token = store.userData.user.token;
  return $.ajax({
...
var editSong = function editSong(id, data) {
  var token = store.userData.user.token;
  return $.ajax({
    url: config.apiOrigin + '/songs/' + id,
    method: 'PATCH',
...
var searchItunes = function searchItunes(search) {
  return $.ajax({
...
var showSongsTemplate = __webpack_require__(19);
var iTunesSongSearchTemplate = __webpack_require__(36);
var api = __webpack_require__(5);

var onCreateSongSuccess = function onCreateSongSuccess() {
  ...
  clearTable();
  api.getSongs().then(onGetSongsSuccess).catch(onGetSongsFailure);
};

var onCreateSongFailure = function onCreateSongFailure() {
...
var onGetSongsSuccess = function onGetSongsSuccess(data) {
  ...
  $('.table-instrument').each(function () {
    ...
    if (instrument === 'saxophone' || instrument === 'alto saxophone' || instrument === 'tenor saxophone' || instrument === 'soprano saxophone' || instrument === 'baritone saxophone') {
      $(this).append(' 🎷');
    }
    if (instrument === 'guitar' || instrument === 'electric guitar' || instrument === 'acoustic guitar' || instrument === 'spanish guitar' || instrument === 'classical guitar') {
      $(this).append(' 🎸');
    }
    if (instrument === 'vocals' || instrument === 'vocal' || instrument === 'voice') {
      $(this).append(' 🎙️');
    }
...
var onGetSongsFailure = function onGetSongsFailure() {
...
var onEditSong = function onEditSong() {
  var elementId = $(this).parent().parent().attr('data-id');
  var instrument = $(this).parent().siblings()[0];
  var composer = $(this).parent().siblings()[1];
...
var onDeleteSong = function onDeleteSong() {
  ...
  $('.confirm-delete-btn').on('click', function () {
    api.deleteSong(elementId).then(onDeleteSongSuccess).catch(onDeleteSongFailure);
  });
...
var onDeleteSongSuccess = function onDeleteSongSuccess() {
...
var onConfirmSong = function onConfirmSong(elementId, instrument, name, composer) {
  var newInstrument = $(instrument).html();
  var newComposer = $(composer).html();
  ...
  api.editSong(elementId, data).then(onEditSongSuccess).catch(onEditSongFailure);
};

var onEditSongSuccess = function onEditSongSuccess() {
...
var onEditSongFailure = function onEditSongFailure() {
...
var onSearchItunesSuccess = function onSearchItunesSuccess(data) {
  var search = JSON.parse(data);
  var showSongsHtml = iTunesSongSearchTemplate({ songs: search.results });
  $('.itunes-search-results').append(showSongsHtml);
};

var onSearchItunesFailure = function onSearchItunesFailure() {
...
module.exports = {
  onCreateSongSuccess: onCreateSongSuccess,
  onCreateSongFailure: onCreateSongFailure,
  onGetSongsSuccess: onGetSongsSuccess,
  onGetSongsFailure: onGetSongsFailure,
  onSearchItunesSuccess: onSearchItunesSuccess,
  onSearchItunesFailure: onSearchItunesFailure,
  clearTable: clearTable,
  onEditSongSuccess: onEditSongSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onLogout = function onLogout() {
  ...
  api.logout(data).then(ui.onLogoutSuccess).catch(ui.onLogoutFailure);
};
...
var onLoginSuccess = function onLoginSuccess(data) {
  ...
  appApi.getSongs().then(appUi.onGetSongsSuccess).catch(appUi.onGetSongsFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<tr data-id=\""
    ...
    + "\">\n  <td class=\"table-instrument\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.instrument : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.composer : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</td>\n  <td>\n    <button class=\"cool-btn edit-song-btn\">Edit</button>\n    <button class=\"cool-btn delete-song-btn\">Delete</button>\n  </td>\n</tr>\n\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div class=\"search-result\">\n  <div class=\"search-content\">\n    <img class=\"album-cover\" src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.artworkUrl100 : stack1), depth0))
    + "\" alt=\"album cover\"/>\n    <div class=\"itunes-search-info\">\n      <h4 class=\"itunes-search-result-song\">Song: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.trackName : stack1), depth0))
    + "</h4>\n      <h4 class=\"itunes-search-result-composer\">Artist: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.artistName : stack1), depth0))
    + "</h4>\n      <h4>Album: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.collectionName : stack1), depth0))
    + "</h4>\n      <h4>Genre: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.primaryGenreName : stack1), depth0))
    + "</h4>\n    </div>\n    <form class=\"itunes-create-song-form\">\n      <input class=\"hidden\" type=\"text\" name=\"song[name]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.trackName : stack1), depth0))
    + "\">\n      <input class=\"hidden\" type=\"text\" name=\"song[composer]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.artistName : stack1), depth0))
    + "\">\n      <input class=\"app-input\" type=\"text\" placeholder=\"My Instrument\" name=\"song[instrument]\">\n      <button class=\"cool-btn btn-success\" type=\"submit\">Add to Repertoire</button>\n    </form>\n  </div>\n</div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
var onSearchItunes = function onSearchItunes(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  $('.itunes-search-results').html('');
  api.searchItunes(data.search).then(ui.onSearchItunesSuccess).catch(ui.onSearchItunesFailure);
};

var onCreateSong = function onCreateSong(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  data.song.user_id = store.userData.user.id;
  api.createSong(data).then(ui.onCreateSongSuccess).catch(ui.onCreateSongFailure);
};
